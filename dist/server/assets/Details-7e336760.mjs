...
import { A as AdoptedPetContext } from "../ServerApp.mjs";
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxs("h2", { children: [
        ...
        /* @__PURE__ */ jsx(Link, { to: "/", children: "Click here" }),
        " ",
...
class Carousel extends Component {
  ...
  render() {
    ...
    return /* @__PURE__ */ jsxs("div", { className: "carousel", children: [
      /* @__PURE__ */ jsx("img", { src: images[active], alt: "animal" }),
      /* @__PURE__ */ jsx("div", { className: "carousel-smaller", children: images.map((photo, index) => (
...
const Details = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "details", children: [
    /* @__PURE__ */ jsx(Carousel, { images: pet.images }),
    /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx("h1", { children: pet.name }),
      /* @__PURE__ */ jsx("h2", { children: `${pet.animal} — ${pet.breed} — ${pet.city}, ${pet.state}` }),
      /* @__PURE__ */ jsxs("button", { onClick: () => setShowModal(true), children: [
        "Adopt ",
        pet.name
      ] }),
      /* @__PURE__ */ jsx("p", { children: pet.description }),
      showModal ? /* @__PURE__ */ jsx(Modal, { children: /* @__PURE__ */ jsxs("div", { children: [
...
function DetailsErrorBoundary(props) {
  return /* @__PURE__ */ jsx(ErrorBoundary$1, { children: /* @__PURE__ */ jsx(Details, { ...props }) });
}
export {
