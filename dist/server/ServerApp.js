...
const Details = lazy(() => import("./assets/Details-9f559e5f.js"));
const AppContainer = () => {
  const adoptedPet = useState(null);
  return /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(AdoptedPetContext.Provider, { value: adoptedPet, children: /* @__PURE__ */ jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxs(
    Suspense,
    {
      fallback: /* @__PURE__ */ jsx("div", { className: "loading-pane", children: /* @__PURE__ */ jsx("h2", { className: "loader", children: "🌀" }) }),
      children: [
